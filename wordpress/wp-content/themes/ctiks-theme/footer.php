 ...
 * Overrides parent theme footer for the Centre for Traditional Indian Knowledge and Skills
 *
 * ============================================================
  ...
  <div class="ctiks-footer-inner">
    ...
    <div class="footer-col">
      ...
      <ul class="footer-links">
		...
		<li><a href="<?php echo esc_url( home_url( '/announcements/' ) ); ?>">Announcements</a></li>
        <li><a href="<?php echo esc_url( home_url( '/news/' ) ); ?>">News</a></li>
        <li><a href="<?php echo esc_url( home_url( '/eventspage/' ) ); ?>">Events</a></li>
      </ul>
    </div>
